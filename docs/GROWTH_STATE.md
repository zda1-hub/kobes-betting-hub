...
- Homepage expert-panel source `70e9dc8` is live on the custom domain through static Worker version `66bd40ca-411d-419c-9522-9e19cf48f556`. Production verification at `kobesbettinghub.com` confirmed the 50-entry exclusive-directory JSON and the visible $19.99 first-month / $10 seven-day promotional offer.
