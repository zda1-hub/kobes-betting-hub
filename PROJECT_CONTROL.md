...
|---|---|---|---|
| 2026-09-20 | Restore the recurring production monitoring start to 08:00 Arizona by merging `X_MONITOR_DAILY_AT=08:00` into the Render worker environment. Deploy `dep-danuu5mk1f9s73a29ecg` is live; fresh startup logs schedule both X and Telegram for `2026-09-20T15:00:00.000Z (08:00 Arizona time)`. The shared 16:00 cutoff is unchanged. | Zakai Martin | Live and startup-verified. |
| 2026-09-19 | Replace the immediate 75% hosted-portal retention offer with 50% off the next monthly invoice. A customer who declines and actually schedules cancellation may then accept one secured 75% last-chance offer after Discord reauthentication; the Worker requires the linked identity, monthly plan, scheduled cancellation, and no prior retention use. Existing invoices/discounts are unchanged. Checkout Worker `0ccdb25a-4fd9-4341-ae78-5218a92de68d`; static Worker `b8ee13b3-a917-4597-b65e-88a97662e006`; 411 tests pass and production health/page/OAuth handoff are verified. | Zakai Martin | Live for future cancellation attempts. Jonah Chavez's existing one-time 75% discount remains unchanged. |
