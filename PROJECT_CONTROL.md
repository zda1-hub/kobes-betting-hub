...
**Last verified:** 2026-09-13 16:34 MST

**Production runtime change set:** repository/Render auto-deploy from `main` at `6989dd1b346508728dea43b3`; Checkout Worker `ff778d91-c34c-4b49-92c9-dfa02785fa37`; Publisher Worker `33bdf3f7-f0aa-4d8b-b133-9b0ec2212365`; public-site Worker `59485719-9cab-42eb-bf90-1074c21f0156`
...
- **Passed:** the Apps Script source is now version-controlled with four no-send/credential/trigger invariants. Three additional tests prove exact image-byte multipart publication, text-only fallback, and fail-closed credential behavior; the complete release suite passes `188/188`.
...
- **Ready to activate on the default branch:** the private membership-operations alarm reads production Supabase in a read-only transaction every two hours and fails visibly on paid-but-unlinked memberships, reconciliation failures, failed webhooks, stuck webhooks, or a stale reconciliation. It emits counts/timestamps only, never customer, subscription, or Discord identifiers.
