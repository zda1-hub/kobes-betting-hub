...
| 2026-09-13 | A read-only Stripe catalog review confirmed the live monthly price is `$32.99/month` and production pins the starter offer to one-time price `price_1U8sr9E6p9BmPii3C2r5jTb4` (“First 7 days — one-time charge”). With action-time owner approval, that correct one-time price was made the product default and the obsolete zero-active-subscription `$10/week` price `price_1U7my7E6p9BmPii3Vy1kZS0p` was archived. No customer or subscription was changed. | Zakai Martin | Complete and UI-verified |
