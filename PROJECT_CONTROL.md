...
**Last verified:** 2026-09-13 19:57 MST
...
| Trends inbox | Gmail Apps Script + D1 + Render | `cloudflare/kobe-trends-inbox.gs`, publisher Worker, bot | D1 queue + approval packet | Credential and Render poll live; Google trigger authorization/installation and one fresh private-card acceptance remain |
...
| 2026-09-13 | Align a rotated dedicated Trends credential across Publisher, Render, and Apps Script; enable five-minute production polling and text-only Free Pick X fallback; save backlog-safe Apps Script activation timestamps. The first poll exposed a missing private approval-channel allowlist entry, which was added before a successful replacement deploy. No credential value or public test content was retained in the audit. | Zakai Martin | Transport live; Google OAuth warning confirmation, trigger installation, and one fresh private-card/email acceptance remain |
